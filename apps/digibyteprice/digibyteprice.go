...
func New() manifest.Manifest {
	return manifest.Manifest{
		...
		Desc:        "Displays the current DigiByte price in one or two fiat currencies and/or in Satoshis. Price data is sourced from Coingecko and updates every 15 minutes.",
