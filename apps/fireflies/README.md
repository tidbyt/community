...
<i>Fireflies with no time</i>
<img src = "./fireflies - no clock.gif" width=900>

<i>Fireflies with current time</i>
...
<i>Select the color of the fireflies.  The default is {***Yellow***}.  There are also four choices from the pallete corresponding to the HTML colors that best approximate the more general firefly colors discussed above.</i>
<img src = "./Color.png" width=400> <img src = "./Pallete.png" width=300> 

<i>When random colors is selected, every firefly has a different random color.  The default is {***Off***}.</i>
