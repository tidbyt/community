...
SUBSHAPES = {
    ...
    "TWO": [
        ["SIX_BY_TWO", 0], ["O0", -2], ["Z0", 0], ["T2", 2], ["O0", 2], ["S0", 1], ["S0", -1]
    ],
    "THREE": [
        ["HORIZONTAL_SLANT", 0], ["SQUARE_HOOK_DOWN", 1], ["SQUARE_HOOK_UP", 1], ["S0", 1], ["S0", -1]
    ],
    "FOUR": [
        ["O0", 1], ["I0", -1], ["O0", 2], ["L0", 0], ["VERTICAL_SLANT_RIGHT", -2], ["TL", 2]
        #["O0", 1], ["I0", -1], ["O0", 2], ["J0", -1], ["VERTICAL_SLANT_RIGHT", 1], ["TL", -1]
    ],
    "FIVE": [
        ["HORIZONTAL_SLANT", 0], ["O0", 2], ["T0", 2], ["S0", 0], ["O0", -2], ["I0", 0], ["L2", -1], ["J2", 2]
    ],
    "SIX": [
        ["BOWL", 0], ["SIX_MIDDLE", 0], ["I0", 0], ["I0", 0]
    ],
    "SEVEN": [
        ["LR", 0], ["JR", 1], ["S0", 2], ["I0", 0], ["L2", -1], ["J2", 2]
    ],
    "EIGHT": [
        ["BOWL", 0], ["TR", -1], ["T2", 2], ["IL", -2], ["I0", 1], ["O0", 2], ["S0", 1], ["JR", -1]
    ],
    "NINE": [
        ["FOUR_BY_TWO", 0], ["TL", 3], ["I0", 0], ["T0", -1], ["T0", 2], ["J2", 2], ["L2", -1], ["I0", 0]
    ],
    "ZERO": [
        ["BOWL", 0], ["VERTICAL_SLANT_LEFT", -2], ["VERTICAL_SLANT_RIGHT", 2], ["FOUR_BY_TWO", 0]
    ]
}
...
def generateFinalPieces(subshape, offset, temp_grid):
    ...
    for piece in subshape:
        if(PIECES.get(piece[0])):
            ...
            while(not collides(temp_grid, temp_piece)):
                temp_piece[2] += 1
            temp_piece[2] -= 1
