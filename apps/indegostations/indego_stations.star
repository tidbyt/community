...
Summary: Display Indego Stations
Description: See dock info for Indego station.
Author: RayPatt
"""
...
def main(config):
    ...
    station_no = int(config.get("Station", 33))
            ...
            children = [
             ...
             render.Row(
                ...
                children = [ 
                    ...
                    render.Row( cross_align = "start", 
                        children = [ 
                                    render.Column(cross_align = "end",
                                        children = [
                                    ...
                                    render.Column(cross_align = "Start",
                                        children = [
                                            render.Text(" Bikes"),
                                            render.Row(
                                                children = [
