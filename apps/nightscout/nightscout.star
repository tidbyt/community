...
def main(config):
    ...
    if nightscout_id == None:
        ...
        return display_failure("Please specify your Nightscout ID")
    ...
    if nightscout_data_cached != None:
        ...
        if resp.status_code == 503:
            ...
            return display_failure("Failed to retieve the Nightscout details with status " + str(resp.status_code))
