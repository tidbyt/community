...
Standings_URL = "https://hs-consumer-api.espncricinfo.com/v1/pages/series/standings?lang=en&seriesId=1326657"
...
TeamOptions = [
    schema.Option(
        display = "Dubai Capitals",
        value = "7034",
    ),
    schema.Option(
        display = "Abu Dhabi Knight Riders",
        value = "7032",
    ),
    schema.Option(
        display = "Desert Vipers",
        value = "7038",
    ),
    schema.Option(
        display = "Gulf Giants",
    ...
    schema.Option(
        display = "Sharjah Warriors",
        value = "6497",
    ),
]

def getTeamFontColor(teamID):
    if teamID == 7032:  # Riders
        return ("#35AEE0")
    elif teamID == 7038:  # Vipers
        return ("#00B3C4")
    elif teamID == 7034:  # Capitals
        return ("#5F259F")
    elif teamID == 7035:  # Giants
        return ("#FE9900")
    elif teamID == 6961:  # Emirates
        return ("#BC2335")
    elif teamID == 6497:  # Warriors
        return ("#00B140")
    return None
