...
#LiveGames_URL = "https://hs-consumer-api.espncricinfo.com/v1/pages/series/home?lang=en&seriesId=1356652" ### WARM-UP MATCHES ###
LiveGames_URL = "https://hs-consumer-api.espncricinfo.com/v1/pages/series/home?lang=en&seriesId=1338037"  ### WC ###
Standings_URL = "https://hs-consumer-api.espncricinfo.com/v1/pages/series/standings?lang=en&seriesId=1338037"

DEFAULT_TEAM = "289"  # Australia
...
def getTeamColor(teamID):
    if teamID == 289:  # Australia
        return ("#e4d727")
    elif teamID == 3379:  # South Africa
        return ("#04822B")
    elif teamID == 3022:  # Pakistan
        return ("#04822B")
    elif teamID == 2614:  # New Zealand
        return ("#fff")
    elif teamID == 1026:  # England
        return ("#f1524f")
    elif teamID == 1863:  # India
        return ("#137dd2")
    elif teamID == 3672:  # Sri Lanka
        return ("#203d89")
    elif teamID == 3867:  # West Indies
        return ("#a04757")
    elif teamID == 2285:  # Ireland
        return ("#59d657")
    elif teamID == 4240:  # Bangladesh
        return ("#2b6746")
    else:
        return ("#fff")
