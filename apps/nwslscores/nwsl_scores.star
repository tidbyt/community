...
Description: Displays live and upcoming NWSL scores from a data feed.
Author: LunchBox8484
"""
...
teamOptions = [
    ...
    schema.Option(
        display = "Angel City FC",
        value = "21422",
    ),
    schema.Option(
        display = "Chicago Red Stars",
        value = "15360",
    ),
    schema.Option(
        display = "Houston Dash",
        value = "17346",
    ),
    schema.Option(
        display = "Kansas City Current",
        value = "20907",
    ),
    schema.Option(
        display = "NJ/NY Gotham FC",
        value = "15364",
    ),
    schema.Option(
        display = "North Carolina Courage",
        value = "15366",
    ),
    schema.Option(
        display = "OL Reign",
    ...
    schema.Option(
        display = "Orlando Pride",
        value = "18206",
    ),
    schema.Option(
        display = "Portland Thorns FC",
        value = "15362",
    ),
    schema.Option(
        display = "Racing Louisville FC",
        value = "20905",
    ),
    schema.Option(
        display = "San Diego Wave FC",
        value = "21423",
    ),
    schema.Option(
        display = "Washington Spirit",
        value = "15365",
    ),
]
