...
Summary: Shows daily horoscope
Description: Displays today's horoscope for a specific sign from USA TodayDisplays today's horoscope for a specific sign from USA Today.
Author: frame-shift
"""
