...
Description: Displays live and upcoming NFL scores from a data feed. For slower scrolling between scores, add the app to your Tidbyt twice, and under the 'Scores To Display' setting, select '1st Half' on the first app instance, and '2nd Half' on the second app instance.
Author: cmarkham20
"""
