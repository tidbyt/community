...
Applet: T20 Blast
Summary: T20 Blast
Description: Shows scores for the T20 Blast cricket tournament.
Author: M0ntyP
...
def main(config):
    ...
    # Cache the Cricinfo list of all T20 Blast matches for 2 hours, could possibly be even longer
    ...
    if Match_JSON["match"]["state"] == "LIVE":
        ...
        # if Title of match is "North Group" then GroupID is 0 otherwise its "South Group" and GroupID is 1
        ...
        SeriesName = "T20 Blast"
        Ladder = Standings_JSON["content"]["standings"]["groups"][GroupID]["teamStats"]
...
TeamOptions = [
    schema.Option(
        display = "Birmingham Bears",
        value = "1479",
    ),
    schema.Option(
        display = "Derbyshire Falcons",
        value = "955",
    ),
    schema.Option(
        display = "Durham",
    ...
    schema.Option(
        display = "Hampshire Hawks",
        value = "1102",
    ),
    schema.Option(
        display = "Kent Spitfires",
        value = "1149",
    ),
    schema.Option(
        display = "Lancashire Lightning",
        value = "1167",
    ),
    schema.Option(
        display = "Leicestershire Foxes",
        value = "1184",
    ),
    schema.Option(
        display = "Northants Steelbacks",
        value = "1272",
    ),
    schema.Option(
        display = "Notts Outlaws",
        value = "1282",
    ),
    schema.Option(
        display = "Middlesex",
    ...
    schema.Option(
        display = "Sussex Sharks",
        value = "1422",
    ),
    schema.Option(
        display = "Worcestershire Rapids",
        value = "1509",
    ),
    schema.Option(
        display = "Yorkshire Vikings",
        value = "1515",
    ),
]
...
def getTeamColor(teamID):
    if teamID == 1479:  # Birm
        ...
        return ("#014997")
    elif teamID == 1035:  # Ess
        return ("#e51b14")
    elif teamID == 1080:  # Glam
        return ("#fed216")
    elif teamID == 1085:  # Glou
        return ("#ffe900")
    elif teamID == 1102:  # Hamp
        return ("#e4d32c")
    elif teamID == 1149:  # Kent
        return ("#a51d36")
    elif teamID == 1167:  # Lanc
        return ("#e4051f")
    elif teamID == 1184:  # Leic
        return ("#519050")
    elif teamID == 1272:  # North
        return ("#811141")
    elif teamID == 1282:  # Notts
        return ("#519050")
    elif teamID == 1241:  # Midd
        return ("#fff")
    elif teamID == 1384:  # Somer
        return ("#d2007e")
    elif teamID == 1409:  # Surr
        return ("#bdfefe")
    elif teamID == 1422:  # Suss
        return ("#0072bc")
    elif teamID == 1509:  # Worc
        return ("#50bee1")
    elif teamID == 1515:  # York
        return ("#73cff2")
    else:
        return ("#fff")
