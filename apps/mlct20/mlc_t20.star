"""
Applet: MLC T20
Summary: Major League Cricket
Description: Shows scores for the Major League Cricket tournament.
Author: M0ntyP
...
def main(config):
    ...
    # Cache the Cricinfo list of all MLC matches for 2 hours, could possibly be even longer
...
TeamOptions = [
    schema.Option(
        display = "Los Angeles Knight Riders",
        value = "7080",
    ),
    schema.Option(
        display = "MI New York",
    ...
    schema.Option(
        display = "San Francisco Unicorns",
        value = "7082",
    ),
    schema.Option(
        display = "Seattle Orcas",
        value = "7083",
    ),
    schema.Option(
        display = "Texas Super Kings",
        value = "7079",
    ),
    schema.Option(
        display = "Washington Freedom",
        value = "7084",
    ),
]
