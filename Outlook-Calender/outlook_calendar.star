...
Author: William Beckhorn
Summary: Display Next Meeting
Description: Shows the date, next meeting and time from your Outlook Calendar. AMS Color Scheme, project based upon another app created by another user.
"""
...
CAL_ICON = base64.decode("""""")
                    ...
                    children = [
                        ...
                        render.Padding(
                            ...
                            child = render.Row(
                                ...
                                expanded = True,
                                children = [
                                    render.Text(cal_date, color = Navy_Blue),
                                ],
                            ),
                        ),
                        render.Padding(
                            ...
                            child = render.Column(
                                ...
                                children = [
                                    render.Marquee(
                                        width = 64,
                                        align = "center",
                                        child = render.Text(cal_meeting_txt, color = Gold),
                                    ),
                                    render.Padding(
                                        pad = (0, 1, 0, 0),
